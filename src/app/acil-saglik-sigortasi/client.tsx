...
const faqs = [
  {
    question: 'Doktorum Benimle Nedir?',
    answer: 'Doktorum Benimle, beklenmedik acil sağlık durumlarında hızlı ve etkili müdahale için tasarlanmış bir sigorta ürünüdür. Acil durumlarda hastane masraflarınızı ve acil tedavi giderlerinizi karşılar.'
  },
  {
    question: 'Doktorum Benimle Hangi Durumları Kapsar?',
  ...
  {
    question: 'Doktorum Benimle\'da Bekleme Süresi Var mı?',
    answer: 'Doktorum Benimle\'da acil durumlar için bekleme süresi bulunmamaktadır. Poliçe başlangıç tarihinden itibaren acil durumlar için teminat aktif olur.'
  },
  {
    question: 'Doktorum Benimle\'dan Kimler Faydalanabilir?',
    answer: "Doktorum Benimle, 0-64 yaş arası herkes için uygundur. Türkiye'de ikamet eden tüm bireyler bu sigortadan yararlanabilir."
  },
  {
    question: 'Doktorum Benimle\'da Anlaşmalı Hastaneler Var mı?',
  ...
  {
    question: 'Doktorum Benimle\'da Ambulans Hizmeti Var mı?',
    answer: 'Evet, Doktorum Benimle kapsamında acil durumlarda ambulans hizmeti teminat altındadır ve ek ücret talep edilmez.'
  },
  {
    question: 'Doktorum Benimle Süresi Nedir?',
    answer: 'Poliçe başlangıç tarihi itibariyle 1 yıldır ve yıllık olarak yenilenebilir.'
  },
  {
    question: 'Doktorum Benimle\'da Ödeme Nasıl Yapılır?',
  ...
  {
    question: 'Doktorum Benimle\'da Aile Üyeleri Eklenebilir mi?',
    answer: 'Evet, eş ve çocuklarınızı poliçenize ekleyebilirsiniz. Aile üyeleri için özel indirimler uygulanmaktadır.'
  },
  {
    question: 'Doktorum Benimle\'da Hasar Bildirimi Nasıl Yapılır?',
  ...
  return (
    <>
      ...
      <section className="page-content">
        <div className="container">
          ...
          <div className="text-content">
            <h3>Beklenmedik acil sağlık durumlarında hızlı ve etkili müdahale için tasarlanmış Doktorum Benimle, ani hastalık veya kaza durumlarında sağlık giderlerinizi güvence altına alır. Acil durumlarda hastane masraflarınızı, acil tedavi giderlerinizi ve acil cerrahi müdahale masraflarınızı karşılayan bu sigorta ürünü, en zor zamanlarda yanınızda olur. Doktorum Benimle, sigortalıların acil sağlık durumlarında anında müdahale edebilmeleri ve en iyi sağlık hizmetlerine erişebilmeleri için hazırlanmıştır. Genel ve özel şartlar dahilinde ve poliçede belirtilen limitler doğrultusunda acil sağlık giderleriniz karşılanır.</h3>
            <h4 id="sigorta-nedir">Doktorum Benimle Nedir?</h4>
            <p>Doktorum Benimle, beklenmedik acil sağlık durumlarında hızlı ve etkili müdahale için tasarlanmış bir sigorta ürünüdür. Kaza sonucu yaralanmalar, ani hastalık durumları, acil cerrahi müdahaleler ve acil tıbbi müdahale gerektiren tüm durumlarda sağlık giderlerinizi güvence altına alır. Acil durumlarda hastane masraflarınızı, acil tedavi giderlerinizi ve acil cerrahi müdahale masraflarınızı karşılayan bu sigorta ürünü, en zor zamanlarda yanınızda olur.</p>
            <h4 id="avantajlar">Doktorum Benimle'un Sunduğu Avantajlar Nelerdir?</h4>
            ...
            <h4>Doktorum Benimle'da Hangi Durumlar Kapsam Dışıdır?</h4>
            <p>Doktorum Benimle kapsamında olmayan durumlar şunlardır:</p>
            <ul className="prop-list">
            ...
            <h4 id="nasil-yaptirilir">Doktorum Benimle Nasıl Yaptırılır?</h4>
            <p>Doktorum Benimle'u en avantajlı ve güvenilir bir şekilde yaptırabilmek için Sigorka.com üzerinden uzman sigorta danışmanları ile iletişime geçerek kendinize en uygun Doktorum Benimle ürününü seçebilirsiniz. Böylelikle bütçenize ve acil sağlık ihtiyaçlarınıza göre sigorta ürünü belirlemeniz kolaylaşır. Aldığınız teklifler içerisinde kendinize en uygun olanı satın alabilmek için Doktorum Benimle başvuru formunu doldurabilirsiniz. Doktorum Benimle, acil durumlarda hızlı müdahale ve en iyi sağlık hizmetlerine erişim sağlamak için tasarlanmıştır.</p>
          </div>
          <div className="col-12 my-5">
            <div className="offer-banner offer-banner-health-bg">
              <div className="offer-banner__content">
                <h3>Doktorum Benimle'a mı ihtiyacınız var?</h3>
      ...
      <section className="page-content pt-0">
        <div className="container">
          <h4>Doktorum Benimle Sıkça Sorulan Sorular</h4>
          <FaqList faqs={faqs} />
        </div>
      </section>
    </>
