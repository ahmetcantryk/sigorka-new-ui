    ...
    <footer className="yuvamFooter">
      ...
      <div className="footerTop">
        ...
        <div className="footerRight">
          <h3 className="socialMediaTitle">Sosyal Medya</h3>
          <div className="socialMediaIcons">
            <a 
              href="https://www.facebook.com/profile.php?id=61562848803157" 
              className="socialIcon" 
              aria-label="Facebook'ta bizi takip edin"
              target="_blank"
              rel="noreferrer noopener"
            >
              <span className="socialIconText">f</span>
            </a>
            <a 
              href="https://www.instagram.com/sigorkacom/" 
              className="socialIcon" 
            ...
            <a 
              href="https://www.linkedin.com/company/sigorkacom/" 
              className="socialIcon" 
      ...
      <div className="footerBottom">
        <p className="copyrightText">
          © {currentYear} sigorka.com – Bereket Sigorta iş birliğiyle sunulmaktadır. Tüm hakları saklıdır.
        </p>
      </div>
    </footer>
  );
