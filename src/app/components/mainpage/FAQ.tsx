  ...
  return (
    <section className="faq">
      <div className="faq__container container">
        <h3 className="section-title"><span>Katılım Sigortacılığı Hakkında Sıkça Sorulan Sorular</span></h3>
        ...
        <div className="d-flex justify-content-center">
          <Link href="/sikca-sorulan-sorular" className="btn btn-secondary">Tümünü Gör</Link>
        </div>
      </div>
    </section>
  );
...
const FaqItem: React.FC<FaqItemProps> = ({ title, content, isActive, onToggle }) => {
  ...
  return (
    <div className={`faq-list__item${isActive ? ' faq-list__item--active' : ''}`}>
      ...
      >
        <h4 className="faq-list__item-title">{title}</h4>
      </a>
      <div 
        ref={contentRef}
