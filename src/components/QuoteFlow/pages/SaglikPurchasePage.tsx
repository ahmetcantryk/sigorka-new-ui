...
import PurchaseStep from '@/components/QuoteFlow/AcilSaglikQuote/steps/PurchaseStep'; // Güncellenmiş import yolu ve bileşen adı

export default function SaglikPurchasePageComponent() { // Bileşen adı güncellendi (RoutePage -> PageComponent)
  ...
  const handleNext = () => {
    // Örnek: router.push(`/saglik/payment-result/${proposalId}`);
  };
