...
import QuoteComparisonStep from '@/components/QuoteFlow/AcilSaglikQuote/steps/QuoteComparisonStep';

export default function SaglikQuoteComparisonPageComponent() {
  ...
  const handleNext = () => {
    if (proposalId) {
      router.push(`/saglik/purchase/${proposalId}`);
    } else {
      router.push('/saglik/satin-al');
    }
  };
