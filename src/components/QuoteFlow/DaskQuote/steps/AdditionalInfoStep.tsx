  ...
  return (
    <Box component="form" onSubmit={formik.handleSubmit} noValidate>
      <Typography variant="h5" component="h2" gutterBottom align="center">
        DASK Sigortası için Ek Bilgiler
      </Typography>

      <Typography variant="body2" color="text.secondary" paragraph align="center">
        DASK Sigortası teklifiniz için gerekli ek bilgileri doldurunuz.
      </Typography>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        <Box>
          <FormControlLabel
            ...
            label="Mevcut DASK Poliçem Var"
          />
          <FormHelperText>
            Halihazırda devam eden bir DASK poliçeniz varsa işaretleyiniz
          </FormHelperText>
        </Box>
          ...
          <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
            <Box sx={{ flex: 1, minWidth: '250px' }}>
              <TextField
                ...
                helperText={formik.touched.previousPolicyNumber && formik.errors.previousPolicyNumber}
                disabled={isSubmitting}
              />
            </Box>
            <Box sx={{ flex: 1, minWidth: '250px' }} />
          ...
          <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
            <Box sx={{ flex: 1, minWidth: '250px' }}>
              <TextField
                ...
                helperText={formik.touched.damageDate && formik.errors.damageDate}
                InputLabelProps={{
                  shrink: true,
                }}
                inputProps={{
            ...
            <TextField
              ...
              helperText={
                formik.touched.additionalNotes
                  ...
                  : 'DASK sigortası teklifinizle ilgili eklemek istediğiniz bilgileri buraya yazabilirsiniz'
              }
              multiline
              rows={4}
              inputProps={{
