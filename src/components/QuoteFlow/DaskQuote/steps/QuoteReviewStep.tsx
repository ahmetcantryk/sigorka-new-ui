  ...
  return (
    <Box>
      <Typography variant="h5" component="h2" gutterBottom align="center">
        DASK Sigortası Teklifleriniz
      </Typography>

      <Typography variant="body2" color="text.secondary" paragraph align="center">
        Size özel hazırlanmış DASK sigortası tekliflerini inceleyebilir ve size en uygun olanı
        seçebilirsiniz.
      </Typography>
        ...
        <>
          <Alert severity="info" sx={{ mb: 4 }}>
            <Typography variant="subtitle2">
              DASK sigorta teklifleri karşılaştırma sonuçları
            </Typography>
          ...
          {selectedQuote && (
            <Paper variant="outlined" sx={{ p: 3, mb: 4 }}>
              <Typography variant="subtitle2" gutterBottom>
                DASK (Doğal Afet Sigortaları Kurumu) Hakkında Önemli Bilgiler
              </Typography>
