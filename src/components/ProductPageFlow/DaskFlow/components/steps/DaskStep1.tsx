...
/**
 * Dask Flow - Kişisel Bilgiler Step Bileşeni
 */
...
import { JOB_OPTIONS, Job, DaskFormData } from '../../types';
                ...
                <div>
                    ...
                    <div className="pp-button-group">
                        <button
                            ...
                            disabled={isLoading}
                        >
                            {isLoading ? 'İşleniyor...' : 'Konut Bilgilerine Geç'}
                        </button>
                    </div>
                </div>
            </div>
