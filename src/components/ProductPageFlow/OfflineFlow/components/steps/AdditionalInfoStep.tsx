...
import { OfflineBranchConfig, OfflineFormData } from '../../types';
    ...
    <div className="product-page-form">
      <div className="pp-card">
        ...
        <p className="pp-subtitle">
          {branchConfig.displayName} talebiniz için eksik bilgilerinizi doldurunuz.
        </p>
