/**
 * TSS Step 1 - Kişisel Bilgiler
 * Kasko PersonalInfoStep ile aynı yapıda
 */
...
import { JOB_OPTIONS, TSS_STORAGE_KEYS } from '../../config/tssConstants';
import { Job, TssStep1Props } from '../../types';
                ...
                <div>
                    ...
                    <div className="pp-button-group">
                        <button
                            ...
                            disabled={isLoading}
                        >
                            {isLoading ? 'İşleniyor...' : 'Sağlık Bilgilerine Geç'}
                        </button>
                    </div>
                </div>
            </div>
